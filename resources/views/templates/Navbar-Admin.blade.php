    <nav class="bg-gray-800 fixed top-0 w-full shadow-lg shadow-zinc-700 z-50" x-data="{ isOpen: false }">
                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            <a href="/dashboard">
                                <h1 class="text-xl font-extrabold text-zinc-50">Dashboard </h1>
                            </a>
                            <a href="/dashboard/kandidats"
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button type="button" @click="isOpen = !isOpen"
                                    ...
                                    <img class="h-8 w-8 rounded-full" src="{{ asset('assets/admin.png') }}"
                                        alt="">
                                </button>
                            </div>
                            ...
                            <div x-show="isOpen" x-transition:enter="transition ease-out duration-100 transform"
                                ...
                                <a href="/dashboard/settings/1/edit" class="block px-4 py-2 text-sm text-gray-700"
                                    role="menuitem" tabindex="-1" id="user-menu-item-1">Settings</a>
                                <form action="{{ route('logout') }}" method="POST">
                                    @csrf
                                    <button type="submit"
                                        class="px-3 py-2 text-base  text-red-600 hover:underline">Logout</button>
                                </form>
        ...
        <div class="md:hidden" id="mobile-menu" x-show="isOpen"
            ...
            <div class="space-y-1 px-2 pb-3 pt-2 sm:px-3">
                ...
                <a href="/dashboard/kandidats/create"
                    ...
                    Kadidat</a>
                <a href="/dashboard/hasil-voting"
                    class="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Hasil
                    Pemilihan</a>
            </div>
            <div class="border-t border-gray-700 pb-3 pt-4">
                <div class="flex items-center px-5">
                    <div class="flex-shrink-0">
                        <img class="h-10 w-10 rounded-full" src="{{ asset('assets/profil.png') }}" alt="">
                    </div>
                    <div class="ml-3">
                        <div class="text-base/5 font-medium text-white">Bima</div>
                        <div class="text-sm font-medium text-gray-400">bima123@gmail.com</div>
                    </div>
                    <button type="button"
                ...
                <div class="mt-3 space-y-1 px-2">
                    <a href="{{ route('profile') }}"
                        ...
                        Profile</a>
                    <a href="/dashboard/settings/1/edit"
